...
**Project:** [GitHub repository](https://github.com/yipkaio/Ledgerly) · [User guide](docs/user-guide.md) · [Documentation index](docs/index.md)

![Ledgerly main dashboard showing date, currency and receipt controls](docs/assets/screenshots/2026-09-23/13-main-dashboard-with-reporting-currency-date-range-and-all-time-total.jpg)

*Dashboard example from the illustrated user guide; the figures shown are sample data.*
...
- [Install Ledgerly](#install-ledgerly)
- [Configure Ledgerly](#configure-ledgerly)
- [Run Ledgerly](#run-ledgerly)
...
Ledgerly is for a bookkeeper who needs to process receipts consistently, retain original evidence, review exceptions and prepare a monthly bank comparison. It is currently designed for a controlled pilot with one approved browser account and a separate trusted integration for Telegram.

## Choose an installation path

| Path | Best for | Instructions |
| --- | --- | --- |
| **Local Docker** | Running the complete app on your own computer. Start here. | Follow [Install](#install-ledgerly), [Configure](#configure-ledgerly) and [Run](#run-ledgerly) below. |
...
### Step 2: Set the local credentials
